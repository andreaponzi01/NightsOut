...
public class ReviewAndResponsePageSetter1 {
    ...
    public static void setter(EventBean eventBean, UserBean userBean, ReviewAndResponseGUIController1 reviewAndResponseGUIController1) throws SQLException {
        reviewAndResponseGUIController1.setAll(eventBean, userBean);
    }
