...
public class InitParticipantsPage2 {
    ...
    public void setter(EventBean2 eventBean, EventParticipantsGUIController2 eventParticipantsGUIController2, JoinEventAppController joinEventAppController) throws SystemException {
        eventParticipantsGUIController2.setAll(eventBean, joinEventAppController);
    }
}
