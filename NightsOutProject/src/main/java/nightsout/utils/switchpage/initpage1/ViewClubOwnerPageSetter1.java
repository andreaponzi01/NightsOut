...
public class ViewClubOwnerPageSetter1 {
    ...
    public void setterView(ClubOwnerBean1 clubOwnerBean, ViewClubOwnerPageGUIController1 viewClubOwnerPageGUIController1, JoinEventAppController joinEventAppController) throws SystemException{
        viewClubOwnerPageGUIController1.setAll(clubOwnerBean,joinEventAppController);
    }
